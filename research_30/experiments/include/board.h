...
/**
 * \brief Calcule le score d'une équipe pour une couleur donnée.
 * \param b Un plateau
 * \param team_id L'identifiant de l'équipe
 * \param color La couleur à considérer (0 pour rouge, 1 pour noir, 2 pour multicolore)
 * \return Un entier représentant le score de l'équipe pour la couleur donnée
 */
int get_team_score_by_color(board b, int team_id, int color); // E.2 : Nouvelle fonction pour calculer le score par couleur
