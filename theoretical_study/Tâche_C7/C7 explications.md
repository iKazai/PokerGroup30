...
Ces résultats ont été écrits dans un fichier intermédiaire, résultats_C6.txt.
...
Ce programme génère, pour chaque \( n \), la valeur de l'approximation, et enregistre les résultats dans un fichier intermédiaire, convergence_resultats.txt.
